...
- **Key:** `AIzaSyDj-jw8nClkwVKtm3nY-BUmlhJksjvpBwc`
...
- **Key:** `AIzaSyD-vel1ckHxW1rZQAcauLUv3WJwlEIIugk`
...
1. **Regenerate Google Generative AI Key**
   ...
   - Create new API key
   - Delete old key: `AIzaSyDj-jw8nClkwVKtm3nY...`

2. **Regenerate Google Places API Key**
   - Go to: https://console.cloud.google.com/apis/credentials
   - Create new API key
   - Delete old key: `AIzaSyD-vel1ckHxW1rZQAcauLUv3WJwlEIIugk`
