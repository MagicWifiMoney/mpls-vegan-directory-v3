...
*Reviewed by Tia — a real visit, real opinions, real photos.*`
  },
  {
    ...
    title: "Best Vegetarian Restaurants in Minneapolis (2026): 30+ Spots by Neighborhood",
    description: "The definitive guide to vegetarian restaurants in Minneapolis: fully vegetarian diners, 100% vegan hotspots, and the best plant-based picks in every neighborhood. 30+ spots, honest reviews, updated April 2026.",
    publishedAt: "2026-02-22",
    updatedAt: "2026-04-23",
    author: "Mia & Jay",
    category: "Guide",
    tags: ["vegetarian restaurants", "minneapolis", "plant-based", "guide", "2026", "vegan-friendly"],
    readingTime: "15 min read",
    tldr: "Best vegetarian restaurants in Minneapolis: Hard Times Cafe (punk-rock diner, all-day breakfast since 1992), Seward Cafe (worker-owned co-op, legendary biscuits & gravy), Modern Times Cafe (Powderhorn greasy-spoon vibes), The Herbivorous Butcher (America's first vegan butcher shop, NE Mpls), Reverie Cafe + Bar (best for omnivore skeptics — full bar, incredible food), Lulu EthioVegan (highest-rated vegan restaurant in the city, 4.9 stars), Dreamstate Cafe (100% vegan, Lyn-Lake), Hi Flora! (plant-based, Lyn-Lake), Heal (North Minneapolis vegan cafe), Hark! Cafe (North Loop). Plus 20+ more vegan-friendly spots across every neighborhood. Minneapolis is one of the best cities in the Midwest for vegetarian dining.",
    faqs: [
      {
        question: "What are the best vegetarian restaurants in Minneapolis?",
        answer: "The top fully vegetarian and vegan restaurants in Minneapolis include: Hard Times Cafe (Cedar-Riverside), Seward Cafe (Seward), Modern Times Cafe (Powderhorn), The Herbivorous Butcher (Northeast), Reverie Cafe + Bar (Powderhorn), Lulu EthioVegan (Elliot Park), Dreamstate Cafe (Lyn-Lake), Hi Flora! (Lyn-Lake), Heal (North Minneapolis), and Hark! Cafe (North Loop). Minneapolis also has 20+ strongly vegetarian-friendly restaurants in every neighborhood."
      },
      {
        question: "Are there any fully vegetarian restaurants in Minneapolis?",
        answer: "Yes — Minneapolis has multiple fully vegetarian or 100% vegan restaurants: Hard Times Cafe, Seward Cafe, Modern Times Cafe (all vegetarian); The Herbivorous Butcher, Reverie Cafe + Bar, Lulu EthioVegan, Francis Burger Joint, Lutunji's Palate, Dreamstate Cafe, Hi Flora!, Heal, Herbie Butcher's Fried Chicken, Hark! Cafe, Vegan East Bakery, and PLNT BSD (all 100% vegan). That's 14+ dedicated vegetarian or vegan restaurants across the city."
      },
      {
        question: "Where can I find vegetarian food in Minneapolis near me?",
        answer: "Vegetarian restaurants are spread across every Minneapolis neighborhood. Cedar-Riverside: Hard Times Cafe. Seward: Seward Cafe. Powderhorn: Modern Times Cafe and Reverie Cafe + Bar. Northeast: The Herbivorous Butcher, Herbie Butcher's Fried Chicken, Francis Burger Joint. Lyn-Lake: Dreamstate Cafe, Hi Flora!, French Meadow Bakery. Elliot Park: Lulu EthioVegan. North Minneapolis: Heal. North Loop: Hark! Cafe. Longfellow: Vegan East Bakery. Use the MPLSVegan neighborhood filter to find spots near you."
      },
      {
        question: "Is Minneapolis a good city for vegetarians?",
        answer: "Yes — Minneapolis is consistently rated one of the best cities in the Midwest for vegetarian dining. The city has 14+ fully vegetarian or vegan restaurants across every major neighborhood, strong community values around plant-based eating, and dozens of vegan-friendly restaurants that take vegetarian options seriously. The Seward and Powderhorn neighborhoods have especially high concentrations of vegetarian dining."
      },
      {
        question: "What vegetarian-friendly restaurants are open late in Minneapolis?",
        answer: "Hard Times Cafe has extended hours and is all-day. Reverie Cafe + Bar serves a full plant-based menu alongside craft beer and cocktails — great late-night option. Black Sheep Pizza (North Loop) stays open late. Pizza Lucé (Downtown, Seward) is open until midnight or later. Many bars and restaurants in Uptown, Northeast, and North Loop neighborhoods have late kitchen hours."
      },
      {
        question: "Can vegetarians eat at vegan restaurants in Minneapolis?",
        answer: "Absolutely — vegan restaurants are vegetarian-friendly by definition. 100% vegan spots like The Herbivorous Butcher, Reverie Cafe + Bar, Lulu EthioVegan, J. Selby's (St. Paul), Dreamstate Cafe, Hi Flora!, and Heal are perfect for vegetarians. You can order anything on the menu without concern about cross-contamination."
      },
      {
        question: "What are the newest vegetarian restaurants in Minneapolis?",
        answer: "Recent additions to the Minneapolis vegetarian scene include Dreamstate Cafe (100% vegan, Lyn-Lake), Hi Flora! (plant-based, Lyn-Lake), Hark! Cafe (100% vegan, North Loop), PLNT BSD (100% vegan), and Herbie Butcher's Fried Chicken (100% vegan, Northeast — a sister concept to The Herbivorous Butcher). Check the MPLSVegan restaurant directory for the most up-to-date list."
      },
      {
        question: "Where can I find cheap vegetarian food in Minneapolis?",
        answer: "Budget vegetarian options in Minneapolis: Hard Times Cafe ($ cash only, huge portions), Seward Cafe ($ worker-owned, affordable), Modern Times Cafe ($ greasy-spoon prices), Lulu EthioVegan ($ Ethiopian, incredibly affordable), Pizza Karma in Dinkytown ($ vegan-friendly pizza near campus), and Afro Deli & Coffee in Cedar-Riverside ($ with excellent plant-based options). Most fully vegetarian spots in Minneapolis are in the $ price range."
      }
    ],
    relatedRestaurants: ["hard-times-cafe", "seward-cafe", "modern-times", "herbivorous-butcher", "reverie-cafe-bar", "lulu-ethiovegan", "dreamstate-cafe", "hi-flora", "heal-mpls", "hark-cafe", "french-meadow", "vegan-east-bakery", "francis-burger-joint", "herbie-butchers-fried-chicken"],
...
Minneapolis has more vegetarian and vegan restaurants per capita than almost any city in the Midwest — and the list keeps growing.

This guide covers every vegetarian restaurant in Minneapolis worth knowing: fully vegetarian diners, 100% vegan spots, and vegan-friendly restaurants where vegetarians eat exceptionally well. We've organized everything by category and neighborhood so you can find the right spot whether you're in Cedar-Riverside or the North Loop, on a $12 budget or celebrating with a full bar menu.

**Quick answer if you need it:** For fully vegetarian, start with [Hard Times Cafe](/restaurants/hard-times-cafe) (Cedar-Riverside) or [Seward Cafe](/restaurants/seward-cafe). For 100% vegan, [Reverie Cafe + Bar](/restaurants/reverie-cafe-bar) and [The Herbivorous Butcher](/restaurants/herbivorous-butcher) are the classics. For the highest-rated restaurant in the city, [Lulu EthioVegan](/restaurants/lulu-ethiovegan) has a 4.9-star average. The full list below covers 30+ spots.

---

## Fully Vegetarian Restaurants in Minneapolis

These restaurants serve no meat whatsoever. For vegetarians who don't want to parse ingredient lists or ask about cross-contamination, these are your safe havens.

### Hard Times Cafe — The OG Since 1992

**Cedar-Riverside | $ | Cash Only | ⭐ 4.5**

The green facade. The anarchist posters. The cash-only sign. [Hard Times Cafe](/restaurants/hard-times-cafe) has been feeding Minneapolis' counterculture since 1992, and it remains one of the best vegetarian restaurants in the city by any measure.

Everything on the menu is vegetarian, most dishes are easily made vegan, and the all-day breakfast situation is genuinely unmatched.

**Must-order:**
- **Vegan Biscuits & Gravy** — Rich mushroom gravy, fluffy biscuits, the real deal
- **Helter Skelter** — Hash browns and tofu scramble, a morning institution
- **Big Fat Pancake** — Served all day (as it should be)
- **Tempeh Reuben** — Thick-cut, tangy, filling
- **Daily baked goods** — Rotating, always worth it

*"Classic diner food and vibes but vegetarian and vegan-ified."* — Mariah Mckenzie

**Heads up:** Cash only, ATM inside. Made-from-scratch means a wait at peak hours. Worth every minute.

---

### Seward Cafe — Worker-Owned Since 1974

**Seward | $ | ⭐ 4.6 (600+ reviews)**

One of the oldest worker-owned cooperatives in Minneapolis, [Seward Cafe](/restaurants/seward-cafe) has been the Seward neighborhood's culinary heart for 50 years. The menu is almost entirely vegetarian, the vegan options are extensive and clearly marked, and the garden patio in summer is one of the best outdoor dining situations in the city.

**Must-order:**
- **Vegan Biscuits & Gravy** — This is the dish that built the cult following
- **Tofu Scramble** — Smoky tempeh, "hands-down the favorite part"
- **Fluffy Pancakes** — With blueberries, chocolate chips, tahini, or jam
- **Monster Mash** — Hot apple cider, miso caramel, coconut whip (order it)
- **Vegan Breakfast Burrito** — A meal, not a snack

*"This has always been a favorite place because they have vegan biscuits and gravy on the menu."* — Alane Klein

Worker-owned means the staff has a stake in doing it right. You can taste it.

---

### Modern Times Cafe — Greasy Spoon, Powderhorn Edition

**Powderhorn | $ | ⭐ 4.7 (400+ reviews)**

[Modern Times Cafe](/restaurants/modern-times) has the greasy-spoon aesthetic locked down — political posters on the walls, formica countertops, strong coffee — but everything on the menu is vegetarian, and the tempeh bacon is criminally good.

This is the spot for a hungover weekend brunch, a cheap weekday lunch, or any time you need comfort food without the meat.

**Must-order:**
- **Tempeh Bacon BLT** — The real reason people come back
- **Veggie Burger** — Genuinely excellent
- **Morning Scramble** — Comfort food done right
- **Daily Soup** — Rotating, always worth asking

*"Punk cafes 4 ever! Love all the vegan options while still fulfilling my greasy spoon cravings."* — Emily Mills

---

## 100% Vegan Restaurants in Minneapolis (Vegetarian-Safe by Default)

100% vegan restaurants serve zero animal products — which means vegetarians can order anything on the menu without worry. Minneapolis has a surprisingly deep bench here.

### The Herbivorous Butcher — America's First Vegan Butcher Shop

**Northeast Minneapolis | $$ | ⭐ 4.6**

[The Herbivorous Butcher](/restaurants/herbivorous-butcher) opened in 2016 and immediately became a Minneapolis landmark. Siblings Aubry and Kale Walch built the first vegan butcher shop in the United States — and the house-made plant meats and aged cashew cheeses are genuinely exceptional.

The deli counter is the main event. The grab-and-go sandwiches make for the best weekday lunch in Northeast.

**Must-order:**
- **Korean BBQ Ribs** — Smoky, tender, convincing
- **Italian Sausage** — The snap is real
- **Aged Cheddar** — Sharp, crumbly, excellent
- **Italian Sub** — House salami and provolone, NE's favorite lunch
- **Weekend specials** — Change weekly, always worth checking

Weekend mornings see lines out the door. Go early or embrace the wait.

---

### Herbie Butcher's Fried Chicken — The Sister Concept

**Northeast Minneapolis | $$ | ⭐ 4.5**

From the same family as The Herbivorous Butcher, [Herbie Butcher's Fried Chicken](/restaurants/herbie-butchers-fried-chicken) does exactly what the name promises — 100% vegan fried chicken that is genuinely crispy, genuinely satisfying, and genuinely weird in the best way.

If you've ever wanted the fried chicken experience without the chicken, this is your spot.

---

### Reverie Cafe + Bar — The Omnivore Converter

**Powderhorn | $$ | ⭐ 4.7**

There is no better restaurant in Minneapolis for convincing a skeptical meat-eater that vegan food can be transcendent. [Reverie Cafe + Bar](/restaurants/reverie-cafe-bar) is a full bar serving scratch-kitchen plant-based food, with 20 rotating craft beers on tap and murals that make the space feel alive.

The Rev Burger — tempeh patty, tomato jam, smoked onions, kimchi aioli — is one of the best burgers in Minneapolis, full stop.

**Must-order:**
- **Rev Burger** — Non-negotiable
- **Lemongrass Tofu Tacos** — Fresh, punchy, addictive
- **Korean BBQ Mock-Duck Tacos** — The other non-negotiable
- **Dark Chocolate Beignets** — "Vegan desserts can be transcendent"
- **Any beer** — 20 rotating taps

For more on Reverie and the full 100% vegan restaurant list, see our [best vegan restaurants Minneapolis guide](/blog/best-vegan-restaurants-minneapolis-2026).

---

### Lulu EthioVegan — Highest-Rated Restaurant in the City

**Elliot Park | $ | ⭐ 4.9 (400+ reviews)**

[Lulu EthioVegan](/restaurants/lulu-ethiovegan) has a 4.9-star average on Google — the highest-rated vegan restaurant in Minneapolis, and one of the highest-rated restaurants period. The food is traditional Ethiopian, which is naturally vegan-friendly, elevated with complex spice blends and exceptional fermented flavors.

The injera alone is worth the trip.

**Must-order:**
- **Beyainatu** — The mixed vegetable plate, the correct way to start
- **Tikel Gomen** — Sautéed cabbage, carrots, potatoes
- **Red Lentil Stew (Misir)** — Spiced, rich, warming
- **Injera** — The spongy sourdough flatbread that makes everything better

---

### Dreamstate Cafe — 100% Vegan, Lyn-Lake

**Lyn-Lake | $$ | ⭐ 4.6**

[Dreamstate Cafe](/restaurants/dreamstate-cafe) is Lyn-Lake's fully plant-based cafe — a neighborhood spot that takes vegan food seriously without taking itself too seriously. The menu hits comfort food from creative angles: creative bowls, elevated sandwiches, baked goods that make you forget they're vegan.

A strong option for a weekday lunch or a slow weekend morning in one of Minneapolis' most walkable corridors.

---

### Hi Flora! — Plant-Based, Lyn-Lake

**Lyn-Lake | $$ | ⭐ 4.5**

[Hi Flora!](/restaurants/hi-flora) is 100% plant-based and brings a lighter, more produce-forward approach to the Lyn-Lake vegan dining corridor. Think bright flavors, seasonal ingredients, and a menu that changes with what's available and what's good.

Worth pairing with a visit to Dreamstate Cafe if you're exploring the neighborhood.

---

### Francis Burger Joint — Vegan Smash Burgers, NE

**Northeast Minneapolis | $ | ⭐ 4.4**

[Francis Burger Joint](/restaurants/francis-burger-joint) does one thing: vegan smash burgers. And it does them well. 100% plant-based, no-apologies comfort food, Northeast location makes it easy to combine with a trip to The Herbivorous Butcher.

---

### Lutunji's Palate — 100% Vegan, Elliot Park

**Elliot Park | $ | ⭐ 4.5**

[Lutunji's Palate](/restaurants/lutunjis-palate) is a 100% vegan cafe in the Elliot Park neighborhood, near Lulu EthioVegan. The menu reflects a global palate with African-influenced flavors and a commitment to honest plant-based cooking.

---

### Vegan East Bakery — 100% Vegan Baked Goods, Longfellow

**Longfellow | $ | ⭐ 4.7**

[Vegan East Bakery](/restaurants/vegan-east-bakery) is exactly what it sounds like: a fully vegan bakery in the Longfellow neighborhood. The pastries, breads, and sweets are made without animal products and are good enough to make you forget the distinction.

See our [vegan bakeries guide](/blog/vegan-bakeries-minneapolis) for the full Minneapolis vegan baked goods roundup.

---

### Heal — 100% Vegan, North Minneapolis

**North Minneapolis | $ | ⭐ 4.5**

[Heal](/restaurants/heal-mpls) brings 100% vegan dining to North Minneapolis — a neighborhood that has historically had fewer plant-based options. The menu focuses on nourishing, whole-food plant-based dishes. A community-oriented spot worth supporting.

---

### Hark! Cafe — 100% Vegan, North Loop

**North Loop | $$ | ⭐ 4.6**

[Hark! Cafe](/restaurants/hark-cafe) is the North Loop's fully vegan option, which matters because the North Loop is otherwise dominated by meat-forward restaurants. Great coffee, solid food, easy spot for a working lunch.

---

### PLNT BSD — 100% Plant-Based

**Minneapolis | $$ | ⭐ 4.4**

[PLNT BSD](/restaurants/plnt-bsd) (Plant Based) is a 100% plant-based concept with a menu built around whole-food ingredients and creative preparations. A newer addition to the Minneapolis vegan scene.

---

## Vegetarian-Friendly Restaurants Worth Knowing

These restaurants aren't exclusively vegetarian, but they take plant-based eating seriously enough to earn a dedicated recommendation. Each of these has multiple vegetarian entrées (not just a token salad).

### French Meadow Bakery & Café — Organic Pioneer Since 1985

**Lyn-Lake | $$ | ⭐ 4.5**

[French Meadow Bakery](/restaurants/french-meadow) was doing organic, locally-sourced food before it was a marketing term. The vegetarian and vegan sections of the menu are extensive and consistently excellent.

**Best vegetarian picks:**
- **Tempeh Reuben** — A genuine classic
- **Tofu Scramble** — Available at breakfast and brunch
- **Blackened Tempeh Tacos** — The lunch standard
- **Vegan baked goods** — Their breads and pastries are legendary

Bonus: free parking lot. A rarity in Minneapolis.

---

### Namaste Cafe — Indian Vegetarian, Uptown

**Uptown | $ | ⭐ 4.5**

[Namaste Cafe](/restaurants/namaste-cafe) brings authentic Indian vegetarian cooking to Uptown. Indian cuisine is one of the world's great vegetarian traditions, and Namaste delivers: dals, curries, chaat, and the best samosas in the neighborhood.

---

### Himalayan Restaurant — Nepali/Indian Vegetarian, Longfellow

**Longfellow | $ | ⭐ 4.6**

[Himalayan Restaurant](/restaurants/himalayan-restaurant) covers the same territory as Namaste but with a Nepali/Indian hybrid menu and a Longfellow location that serves a different corner of the city. The dal bhat and vegetable curries are excellent.

---

### Afro Deli & Coffee — East African, Cedar-Riverside

**Cedar-Riverside | $ | ⭐ 4.5**

[Afro Deli & Coffee](/restaurants/afro-deli) anchors the Cedar-Riverside dining scene with East African flavors and a menu that includes strong vegetarian options. The lentil dishes and sambuusas are highlights. Cedar-Riverside already has Hard Times Cafe for dedicated vegetarian dining — Afro Deli fills the gap for savory East African vegetarian options.

---

### The Wedge Table — Local Organic, Whittier

**Whittier | $$ | ⭐ 4.4**

[The Wedge Table](/restaurants/wedge-table) is the restaurant arm of the Wedge Community Co-op — one of Minneapolis' oldest food co-ops. The menu emphasizes local, organic ingredients, and vegetarian options are always well-represented. The neighborhood is walkable and the seasonal menu keeps things interesting.

---

### May Day Cafe — Neighborhood Cafe, Powderhorn

**Powderhorn | $ | ⭐ 4.4**

[May Day Cafe](/restaurants/may-day-cafe) is a Powderhorn neighborhood staple — low-key, community-oriented, with a menu that includes solid vegetarian options. If you're already in Powderhorn for Modern Times or Reverie, May Day is around the corner.

---

### Pizza Lucé — Vegan Toppings, Downtown + Seward

**Downtown + Multiple Locations | $$ | ⭐ 4.4**

[Pizza Lucé](/restaurants/pizza-luce) has been a Minneapolis institution since the 1990s, and they've always taken vegan and vegetarian pizza seriously. Vegan cheese, house-made dough, and a menu where plant-based isn't an afterthought. Multiple locations including Downtown and Seward, open late.

---

### Black Sheep Pizza — Creative Pies, North Loop

**North Loop | $$ | ⭐ 4.5**

[Black Sheep Pizza](/restaurants/black-sheep-pizza) does coal-fired pizza with creative toppings and solid vegetarian options. The North Loop location makes it useful for pre-show dining or a post-work meal. The roasted veggie combinations are well-executed.

---

### World Street Kitchen — Global Street Food, Lyn-Lake

**Lyn-Lake | $$ | ⭐ 4.5**

[World Street Kitchen](/restaurants/world-street-kitchen) brings global street food to the Lyn-Lake corridor with a menu that rotates around different world cuisines. Vegetarian options are always present and always interesting — often the more creative dishes on the menu.

---

### Glam Doll Donuts — Vegan Donuts + More, Lyn-Lake

**Lyn-Lake | $ | ⭐ 4.5**

[Glam Doll Donuts](/restaurants/glam-doll-donuts) has been doing spectacular vegan donuts (alongside regular ones) since 2013. If you're walking Lyn-Lake after a meal at French Meadow or Hi Flora!, this is the obvious dessert stop.

---

### Pizza Karma — Vegan-Friendly Pizza, Dinkytown

**Dinkytown | $ | ⭐ 4.4**

[Pizza Karma](/restaurants/pizza-karma) in Dinkytown serves good-value vegan-friendly pizza near the U of M campus. The vegan cheese and plant-based toppings are solid, and the prices are student-friendly.

---

### Sift Gluten Free — GF Vegan Bakery, Longfellow

**Longfellow | $ | ⭐ 4.6**

[Sift Gluten Free](/restaurants/sift-gluten-free) is a gluten-free bakery with extensive vegan options — useful if you're navigating both dietary needs simultaneously. The Longfellow location serves a neighborhood with several other good vegan dining options nearby.

---

### Victor's 1959 Cafe — Cuban, Kingfield

**Kingfield | $$ | ⭐ 4.5**

[Victor's 1959 Cafe](/restaurants/victors-1959) brings Cuban flavors to the Kingfield neighborhood with vegetarian-friendly options woven throughout the menu. The black beans and rice, Cuban sandwiches with vegetarian modifications, and fresh juices make it a strong option for groups with mixed dietary preferences.

---

### Crisp & Green — Salads + Bowls, Downtown

**Downtown | $$ | ⭐ 4.3**

[Crisp & Green](/restaurants/crisp-and-green) is a fast-casual salad and grain bowl concept in Downtown Minneapolis with a menu that's almost entirely vegetarian-friendly. Good for a weekday lunch when you're working downtown and want something clean and fast.

---

## Vegetarian Restaurants in Minneapolis, By Neighborhood

Use this as your quick-reference neighborhood guide:

**Cedar-Riverside:**
- [Hard Times Cafe](/restaurants/hard-times-cafe) — Fully vegetarian, cash only, all-day breakfast since 1992
- [Afro Deli & Coffee](/restaurants/afro-deli) — East African, strong vegetarian options

**Seward:**
- [Seward Cafe](/restaurants/seward-cafe) — Worker-owned, almost entirely vegetarian, garden patio

**Powderhorn:**
- [Modern Times Cafe](/restaurants/modern-times) — Fully vegetarian, greasy-spoon vibes
- [Reverie Cafe + Bar](/restaurants/reverie-cafe-bar) — 100% vegan, full bar, best for date night

**Northeast Minneapolis:**
- [The Herbivorous Butcher](/restaurants/herbivorous-butcher) — 100% vegan butcher shop + deli
- [Herbie Butcher's Fried Chicken](/restaurants/herbie-butchers-fried-chicken) — 100% vegan fried chicken
- [Francis Burger Joint](/restaurants/francis-burger-joint) — 100% vegan smash burgers

**Lyn-Lake:**
- [French Meadow Bakery](/restaurants/french-meadow) — Vegan-friendly, organic pioneer
- [Dreamstate Cafe](/restaurants/dreamstate-cafe) — 100% vegan
- [Hi Flora!](/restaurants/hi-flora) — 100% plant-based
- [Glam Doll Donuts](/restaurants/glam-doll-donuts) — Vegan donuts + pastries
- [World Street Kitchen](/restaurants/world-street-kitchen) — Vegan-friendly global street food

**Elliot Park:**
- [Lulu EthioVegan](/restaurants/lulu-ethiovegan) — 100% vegan Ethiopian, 4.9 stars
- [Lutunji's Palate](/restaurants/lutunjis-palate) — 100% vegan, African-influenced

**Uptown:**
- [Namaste Cafe](/restaurants/namaste-cafe) — Indian vegetarian

**Whittier:**
- [The Wedge Table](/restaurants/wedge-table) — Local organic, co-op restaurant

**North Loop:**
- [Black Sheep Pizza](/restaurants/black-sheep-pizza) — Vegan-friendly pizza
- [Hark! Cafe](/restaurants/hark-cafe) — 100% vegan

**North Minneapolis:**
- [Heal](/restaurants/heal-mpls) — 100% vegan

**Longfellow:**
- [Himalayan Restaurant](/restaurants/himalayan-restaurant) — Nepali/Indian, strong vegetarian
- [Vegan East Bakery](/restaurants/vegan-east-bakery) — 100% vegan bakery
- [Sift Gluten Free](/restaurants/sift-gluten-free) — GF + vegan bakery

**Kingfield:**
- [Victor's 1959 Cafe](/restaurants/victors-1959) — Cuban, vegetarian-friendly

**Downtown:**
- [Pizza Lucé](/restaurants/pizza-luce) — Vegan-friendly pizza, open late
- [Crisp & Green](/restaurants/crisp-and-green) — Salads and bowls

**Dinkytown:**
- [Pizza Karma](/restaurants/pizza-karma) — Vegan-friendly pizza near campus

---

## Vegetarian in Minneapolis: Practical Tips

**1. 100% vegan = 100% vegetarian.** If a restaurant is 100% vegan, everything on the menu is safe for vegetarians. No cross-contamination concerns, no asking about ingredients. Order freely.

**2. "Vegan-friendly" still means look before you order.** These restaurants have excellent vegetarian options but also serve meat. Check the menu or ask your server.

**3. Seward and Powderhorn are the epicenters.** Both neighborhoods have multiple fully vegetarian or vegan restaurants within walking distance of each other. If you're on a vegetarian dining tour of Minneapolis, start here.

**4. The brunch scene is elite.** Hard Times, Seward Cafe, and Modern Times form an all-day breakfast triangle that competes with cities three times the size. See our [vegan brunch guide](/blog/vegan-brunch-minneapolis) for the full picture.

**5. Northeast is your best bet for vegan comfort food.** The Herbivorous Butcher, Herbie Butcher's Fried Chicken, and Francis Burger Joint are all within a few minutes of each other. That's a full day of eating.

**6. Budget is not a barrier.** Hard Times ($), Seward Cafe ($), Lulu EthioVegan ($), and Modern Times ($) are all under $15 for a full meal. Minneapolis' vegetarian dining scene is not exclusively upscale.

**7. Gluten-free + vegan is possible.** Sift Gluten Free in Longfellow handles both. Ask about GF options at Lulu EthioVegan (injera contains gluten, but most dishes can be served without it).

---

## The Bottom Line

Minneapolis has 14+ fully vegetarian or vegan restaurants and 20+ more vegan-friendly spots that take plant-based eating seriously. Every neighborhood has options. Every budget is covered.

Start with [Hard Times Cafe](/restaurants/hard-times-cafe) for the biscuits and gravy. Go to [Lulu EthioVegan](/restaurants/lulu-ethiovegan) for the highest-rated meal in the city. End with [Reverie Cafe + Bar](/restaurants/reverie-cafe-bar) for a beer and the Rev Burger.

Browse the [full restaurant directory](/restaurants) — filter by neighborhood, dietary status, price range, or cuisine type — or check our [complete 2026 vegan guide](/blog/best-vegan-restaurants-minneapolis-2026) for the ranked list of every spot worth visiting.
`
  },
  {
...
For more Minneapolis vegan dining, check our [vegan brunch guide](/blog/best-vegan-brunch-minneapolis) and [Minneapolis vegan food truck guide](/blog/minneapolis-vegan-food-trucks).
  ...
  {
    slug: "vegan-date-night-restaurants-minneapolis",
    title: "Best Vegan Date Night Restaurants in Minneapolis (2026 Guide)",
    description: "The best romantic restaurants in Minneapolis for vegan dates — from upscale plant-based tasting menus to cozy neighborhood spots with exceptional vegan options. Whether you're both vegan or navigating mixed dietary needs, these spots deliver.",
    publishedAt: "2026-04-16",
    updatedAt: "2026-04-16",
    author: "Mia & Jay",
    category: "Guide",
    tags: ["vegan date night minneapolis", "romantic vegan restaurants minneapolis", "vegan restaurants minneapolis date", "best vegan date night minneapolis", "plant based date night minneapolis", "vegan fine dining minneapolis"],
    readingTime: "8 min read",
    tldr: "Best vegan date night in Minneapolis: J. Selby's (St. Paul, upscale full-vegan menu, the top special-occasion pick), Tori Ramen (NE Mpls, cozy intimate ramen with vegan broth options), Tongue in Cheek (NE Mpls, creative plant-forward menu in a romantic space), Gandhi Mahal (Seward, river view + exceptional vegan Indian), Reverie Cafe + Bar (Powderhorn, intimate fully vegan bar with craft cocktails), and Shish Mediterranean (Midtown, excellent vegan mezze for sharing).",
    faqs: [
      {
        question: "What is the best vegan restaurant for a date in Minneapolis?",
        answer: "J. Selby's in St. Paul (Cathedral Hill, 169 Western Ave N) is the top upscale choice — a fully vegan menu in a refined setting that works perfectly for a special occasion date. In Minneapolis proper, Tongue in Cheek (NE Minneapolis) and Gandhi Mahal (Seward, with Mississippi River views) are excellent romantic options with strong vegan menus."
      },
      {
        question: "Are there vegan restaurants in Minneapolis good for dates with non-vegans?",
        answer: "Yes — several Minneapolis restaurants have strong vegan menus while also serving non-vegan options, making them great for mixed couples. Top picks: Tongue in Cheek (NE Mpls, creative American menu with excellent vegan options), Tori Ramen (NE Mpls, vegan tonkotsu broth available), and Shish Mediterranean (Midtown, extensive vegan mezze alongside traditional dishes). Non-vegan partners won't feel like they're compromising."
      },
      {
        question: "Is there vegan fine dining in Minneapolis?",
        answer: "The closest to fine dining is J. Selby's in St. Paul — a fully vegan restaurant with an upscale atmosphere, white tablecloths, and a menu featuring house-made pasta, elevated appetizers, and a proper cocktail program. In Minneapolis, Tongue in Cheek offers a similar creative, refined approach to plant-forward cooking in a chic Northeast setting."
      },
      {
        question: "Where can I buy vegan meat and cheese alternatives in Minneapolis?",
        answer: "The Herbivorous Butcher (507 1st Ave NE, Northeast Minneapolis) is a 100% vegan butcher shop making house-crafted vegan meats and cheeses from scratch — gyros, chorizo, smoked gouda, aged cheddar, and dozens more. It's the best source for vegan deli-style products in the Twin Cities. All Minneapolis co-ops and Whole Foods also carry major brands like Beyond Meat, Impossible, Violife, and Miyoko's."
      },
      {
        question: "Are there vegan grocery stores in Minneapolis on a budget?",
        answer: "Yes — Aldi and Trader Joe's are the most budget-friendly options with strong plant-based selections. Aldi's Earth Grown brand has excellent frozen plant-based options at very low prices. Trader Joe's (several Twin Cities locations) has a broad private-label vegan range. Co-op bulk sections also offer good value per pound on staples like legumes, grains, and nuts."
      },
      {
        question: "Does Minneapolis have any fully vegan grocery stores?",
        answer: "Not a full-scale grocery store, but The Herbivorous Butcher (NE Minneapolis) is a fully vegan specialty shop focused on meat and cheese alternatives, and Dream State Cafe carries a curated selection of vegan snacks and pantry items alongside their cafe menu. Most vegan grocery shopping in Minneapolis happens at the well-stocked co-ops and natural food stores."
      }
    ],
    relatedRestaurants: ["herbivorous-butcher", "seward-cafe", "wedge-table", "dreamstate-cafe", "j-selbys"],
    relatedPosts: ["best-vegan-restaurants-minneapolis-2026", "vegan-date-night-restaurants-minneapolis", "vegan-bars-breweries-minneapolis", "vegan-restaurants-uptown-minneapolis"],
    content: `
...
**Edina | 3720 W 69th St**
**Uptown | 222 Hennepin Ave S**
...
`,
...

  {
    ...
    relatedRestaurants: ["reverie-cafe-bar", "francis-burger-joint", "the-dripping-root", "hard-times-cafe", "bryant-lake-bowl", "modern-times"],
    relatedPosts: ["vegan-date-night-restaurants-minneapolis", "best-vegan-restaurants-minneapolis-2026", "vegan-restaurants-uptown-minneapolis", "vegan-brunch-minneapolis"],
    content: `
...
| Bar | Fully Vegan? | Best For |
|---|---|---|
| Reverie Cafe + Bar | Yes | Cocktails, dessert, great atmosphere |
| Francis Burger Joint | Yes | Sports bar, groups, burgers |
| Hard Times Cafe | Yes | Cheap food, dive bar, community vibe |
| The Dripping Root | Plant-based menu | Kava, alcohol-free evenings |
| Surly Brewing | No (strong vegan menu) | Best brewery food in Minneapolis |
| Bryant Lake Bowl | No (good vegan options) | Unique experience, groups |

For more on where to eat and drink in Minneapolis as a vegan, explore the [MPLS Vegan restaurant directory](/restaurants) — searchable by neighborhood, cuisine type, and dietary need.
`,
  },
...
`,
  ...
  {
    slug: "plant-based-restaurants-minneapolis",
    title: "Plant-Based Restaurants in Minneapolis (2026 Guide)",
    description: "Minneapolis plant-based restaurants, organized by what you're craving. From fully vegan spots to menus where plant-based dishes are the actual focus — not an afterthought.",
    publishedAt: "2026-04-16",
    updatedAt: "2026-04-16",
    author: "Mia & Jay",
    category: "Guide",
    tags: ["plant-based restaurants minneapolis", "vegan restaurants minneapolis", "plant-based dining minneapolis", "vegetarian restaurants minneapolis", "fully vegan minneapolis"],
    readingTime: "6 min read",
    tldr: "Best plant-based restaurants in Minneapolis: J. Selby's (St. Paul, fully vegan, best comfort food in the metro), Herbivorous Butcher (plant-based deli shop + sandwiches), Reverie Cafe + Bar (fully vegan bar + cafe, South Minneapolis), Seward Cafe (co-op, affordable, plant-forward since 1974), Hard Times Cafe (volunteer-run, sliding scale, vegan-friendly dive). Strong mixed-menu options: Birchwood Cafe (seasonal vegetable-forward), French Meadow Bakery (organic, labeled vegan options), Black Sheep Pizza (coal-fired, Violife cheese available).",
    faqs: [
      {
        question: "How many plant-based restaurants are in Minneapolis?",
        answer: "Minneapolis has dozens of fully vegan and plant-forward restaurants, more than most cities its size. The number has grown significantly since 2018 and continues to expand. The MPLS Vegan directory tracks current openings and closings."
      },
      {
        question: "What's the difference between plant-based and vegan?",
        answer: "In practice, 'plant-based' often signals a health or environmental motivation rather than an ethical one, and it's increasingly used by restaurants that want to appeal to a broader audience. The food is the same — no meat, dairy, or eggs — but the framing is different."
      },
      {
        question: "Is Minneapolis a good city for plant-based eating?",
        answer: "Yes. Minneapolis consistently ranks among the most vegan-friendly cities in the Midwest and often in the top tier nationally. The co-op culture, strong food scene, and engaged local community have supported plant-based restaurants here for decades."
      },
      {
        question: "Are plant-based restaurants in Minneapolis expensive?",
        answer: "Range is wide. Hard Times Cafe uses sliding scale pricing. Seward Cafe is very affordable. Birchwood and higher-end spots are more expensive. Most fall in the mid-range — comparable to any restaurant in the city."
      }
    ],
    relatedRestaurants: ["seward-cafe", "herbivorous-butcher", "reverie-cafe-bar", "hard-times-cafe", "birchwood-cafe", "french-meadow"],
    relatedPosts: ["best-vegan-restaurants-minneapolis-2026", "vegan-brunch-minneapolis", "best-vegan-bakeries-minneapolis", "northeast-minneapolis-vegan-guide"],
    content: `
...
**J. Selby's** (St. Paul)
The metro's best fully vegan restaurant, full stop. Comfort food executed well — burgers, mac, scrambles, tacos. The kind of place where you forget to check whether something is vegan because everything is. Weekend brunch draws lines. Worth it.

**The Herbivorous Butcher**
A plant-based meat and cheese shop that also does sandwiches. The products — seitan, nut-based cheeses, deli-style meats — are what put Minneapolis on the national plant-based food map. The Reuben is better than it has any right to be.

**Reverie Cafe + Bar**
A South Minneapolis cafe with a rotating menu built around plants and quality ingredients. Better coffee than most dedicated cafes, and brunch options that don't feel like an afterthought. Low-key atmosphere, high-quality execution.

**Seward Cafe**
Cooperative, community-run, and plant-forward since 1974. Breakfast and lunch, affordable, reliably vegan-friendly. No frills, but the food is good and the prices are honest.

**Hard Times Cafe**
Volunteer-run, sliding scale pricing, late hours. West Bank institution. The food is simple and the atmosphere is eclectic, but it's been part of Minneapolis vegan history for decades and it's worth knowing about.
...
**Birchwood Cafe**
One of Minneapolis's most respected neighborhood restaurants, and the vegetable-forward dishes here are genuinely some of the best cooking in the city. Local sourcing, seasonal menus, clear labeling.

**French Meadow Bakery & Cafe**
Organic, health-focused, and a genuine commitment to plant-based options since before it was common. The bakery side means excellent bread and pastries. The cafe side has a full menu where plant-based items are clearly marked and well-executed.

**Black Sheep Pizza**
Coal-fired pizza with Violife cheese available. The crust is exceptional — high heat, proper char — and the vegan options hold up in that environment better than at lower-temperature ovens.

**Pizza Luce**
Minneapolis pizza institution with dedicated vegan options developed over two decades. Multiple locations. Consistent execution. The vegan cheese actually melts.
...
Minneapolis has a strong Thai food scene, and Thai restaurants are generally plant-friendly by default. Many dishes can be made vegan easily.

**Indian**
Indian cuisine has more naturally plant-based dishes than most. Dal, chana masala, aloo gobi, saag — many Indian restaurants in Minneapolis have full sections of the menu that are plant-based without any modification.

**Ethiopian**
Injera and lentil-based wots are traditionally plant-based (especially during fasting periods). The [Ethiopian restaurants in Minneapolis](/blog/vegan-ethiopian-minneapolis) tend to have strong plant-based options built into the menu.

**Mediterranean and Middle Eastern**
Hummus, falafel, tabbouleh, roasted vegetables, grain-based dishes — Mediterranean restaurants offer some of the easiest fully plant-based eating in the city.
...
The [MPLS Vegan restaurant directory](/restaurants) tracks plant-based and vegan-friendly restaurants across the Twin Cities and updates as new spots open.

If you're looking for something specific — [vegan brunch in Minneapolis](/blog/best-vegan-brunch-minneapolis), [vegan pizza](/blog/best-vegan-pizza-minneapolis), or [vegan bakeries](/blog/best-vegan-bakeries-minneapolis) — we have dedicated guides for those too.
`,
  },

  {
    slug: "vegan-ethiopian-minneapolis",
    title: "Vegan Ethiopian Restaurants in Minneapolis (2026 Guide)",
    description: "Minneapolis has excellent Ethiopian restaurants with extensive vegan menus. Ethiopian cuisine is naturally built for plant-based eating — injera, lentils, veggie combos. Here's where to go.",
    publishedAt: "2026-04-16",
    updatedAt: "2026-04-16",
    author: "Mia & Jay",
    category: "Guide",
    tags: ["vegan Ethiopian Minneapolis", "Ethiopian restaurants Minneapolis vegan", "plant-based Ethiopian food Minneapolis", "injera vegan Minneapolis", "vegan Ethiopian food Twin Cities"],
    readingTime: "5 min read",
    tldr: "Best vegan Ethiopian food in Minneapolis: Fasika Ethiopian Restaurant (South Minneapolis, best vegetarian combination plate in the city, properly fermented injera), Flamingo Restaurant (Seward, Ethiopian and Somali mix, affordable fasting plate). Ethiopian cuisine is one of the most naturally vegan-friendly food traditions — the fasting menu is fully plant-based at every restaurant.",
    faqs: [
      {
        question: "Is Ethiopian food vegan-friendly in Minneapolis?",
        answer: "Very. Ethiopian cuisine has a long tradition of extensive vegetarian and vegan cooking due to religious fasting practices. Minneapolis restaurants that serve the Ethiopian community maintain this — the vegetarian fasting plate at most Ethiopian restaurants is fully vegan and often the most interesting part of the menu."
      },
      {
        question: "What is injera and is it vegan?",
        answer: "Injera is a sourdough flatbread made from teff, a grain native to Ethiopia. It's fermented for two to three days before cooking on a large round griddle. It's naturally vegan (no dairy or eggs), naturally gluten-free, and serves as both plate and utensil for Ethiopian meals."
      },
      {
        question: "What Ethiopian dishes are vegan?",
        answer: "The core vegan dishes you'll find at Ethiopian restaurants: misir (red lentils in berbere spice), atkilt (cabbage, carrots, potatoes), gomen (collard greens), shiro (chickpea flour stew), fosolia (green beans), and timatim fitfit (tomato salad with torn injera). Any of these prepared for the fasting menu will be oil-based rather than butter-based."
      },
      {
        question: "Where is the Ethiopian community in Minneapolis?",
        answer: "The East African community is concentrated in several neighborhoods, including Seward, Cedar-Riverside, and along Lake Street. Restaurants in and around these areas tend to have the most established and authentic Ethiopian menus."
      }
    ],
    relatedRestaurants: [],
    relatedPosts: ["ethiopian-vegan-food-minneapolis", "best-vegan-restaurants-minneapolis-2026", "plant-based-restaurants-minneapolis", "northeast-minneapolis-vegan-guide"],
    content: `
...
**Heads up:** Weekend evenings get busy. Weekday lunch is often quieter and the food is just as good.
...
**Looking for more vegan restaurant options in Minneapolis?** Browse the [MPLS Vegan restaurant directory](/restaurants) or explore:

- [Best Vegan Brunch in Minneapolis](/blog/best-vegan-brunch-minneapolis)
- [Plant-Based Restaurants in Minneapolis](/blog/plant-based-restaurants-minneapolis)
- [Vegan Restaurants in Northeast Minneapolis](/blog/northeast-minneapolis-vegan-guide)
`,
  },

  {
    slug: "vegan-food-delivery-minneapolis",
    title: "Vegan Food Delivery in Minneapolis: What Actually Works (2026)",
    description: "The real guide to vegan food delivery in Minneapolis — which apps to use, which restaurants hold up, and which ones turn into a disappointment by the time they arrive.",
    publishedAt: "2026-04-16",
    updatedAt: "2026-04-16",
    author: "Mia & Jay",
    category: "Guide",
    tags: ["vegan food delivery minneapolis", "vegan delivery minneapolis", "best vegan delivery minneapolis", "order vegan minneapolis", "plant-based delivery minneapolis"],
    readingTime: "6 min read",
    tldr: "Best vegan food delivery in Minneapolis: Ethiopian food (Afro Deli on DoorDash/Uber Eats, combo platters travel well), True Thai (vegan-labeled items, curries hold up), Pizza Lucé (reliable vegan cheese, consistent delivery). Use DoorDash for the widest selection. Avoid delivery for brunch items, crispy foods, and salads — they don't survive the trip.",
    faqs: [
      {
        question: "Does DoorDash have a vegan filter in Minneapolis?",
        answer: "There's a vegetarian filter but no dedicated vegan filter. Your best option is to search for specific restaurants you know have vegan menus, or search for 'vegan' as a cuisine type and sort through the results."
      },
      {
        question: "What's the best vegan delivery food for a group?",
        answer: "Ethiopian food. Large combo platters travel well, the variety covers different tastes, and the price-per-person is reasonable. Afro Deli is the most consistent option."
      },
      {
        question: "Are there fully vegan restaurants that deliver in Minneapolis?",
        answer: "Yes, though availability changes. Check current DoorDash and Uber Eats listings for restaurants in your area — fully plant-based spots with delivery capability vary by neighborhood and time of year."
      },
      {
        question: "What vegan food can I get delivered late night in Minneapolis?",
        answer: "Late-night vegan delivery options are limited. The apps have more options between 6–9pm than after 10pm. Thai and certain fast-casual spots tend to have the latest hours. Search by delivery time availability rather than cuisine type after 10pm."
      }
    ],
    relatedRestaurants: [],
    relatedPosts: ["plant-based-restaurants-minneapolis", "vegan-ethiopian-minneapolis", "best-vegan-pizza-minneapolis", "best-vegan-brunch-spots-minneapolis"],
    content: `
## Vegan Food Delivery in Minneapolis: The Honest Version

Most guides to vegan food delivery in Minneapolis are basically app screenshots with restaurant names. That's not useful. What you actually need to know: which restaurants survive a 30-minute delivery, which ones fall apart in a bag, and which apps have enough vegan options to be worth opening.

Minneapolis has a genuinely good vegan restaurant scene. The delivery version of that scene is smaller — not every great vegan restaurant delivers well, and not every restaurant that delivers is actually great.

Here's what works.

---

## Which Delivery Apps to Use in Minneapolis

**DoorDash** has the widest vegan selection in the Twin Cities. Most of the dedicated plant-based spots are on it, plus a large chunk of the restaurants that have strong vegan menus. If you only use one app, use this one.

**Uber Eats** is close. The selection overlaps heavily with DoorDash, but pricing varies enough that it's worth checking both when you're ordering from a specific restaurant.

**Grubhub** has a smaller Minneapolis presence. Worth checking for specific restaurants, but don't rely on it as your primary app — the coverage gaps are real.

One thing none of the apps do well: filtering for vegan specifically. Searching the restaurant name directly and reading the menu is usually faster than trusting the filters.

---

## Restaurants That Actually Deliver Well

### Ethiopian and East African

Ethiopian food is one of the best delivery categories for vegan eaters in Minneapolis. The food is already meant to be eaten communally and at room temperature — injera and lentil-based wats don't deteriorate in transit the way, say, a veggie burger does.

**Afro Deli** (multiple locations, on DoorDash and Uber Eats) consistently delivers well. The combo platters with misir wat and gomen arrive in good shape, and portions are generous.

For more on the Ethiopian vegan scene, see our [guide to vegan Ethiopian food in Minneapolis](/blog/vegan-ethiopian-minneapolis).

### Thai Food

**True Thai** is often mentioned for a reason. They have vegan-labeled items on delivery platforms and the food holds up — curries stay warm, tofu stays textured enough to be worth eating.

When ordering Thai for delivery, the pad see ew and yellow curry tend to travel better than fried rice or anything with crispy elements.

### Pizza

Pizza Lucé is the most reliable vegan delivery pizza in Minneapolis. They have years of experience with dairy-free cheese, clearly labeled vegan options, and the pies arrive in decent shape.

For a full breakdown, see our [guide to vegan pizza in Minneapolis](/blog/best-vegan-pizza-minneapolis).

---

## What Doesn't Survive Delivery

**Brunch items.** Tofu scrambles, avocado toast, vegan pancakes — all of these suffer on delivery. If you want vegan brunch, go in person. The [best vegan brunch spots in Minneapolis](/blog/best-vegan-brunch-spots-minneapolis) are worth the trip.

**Anything that depends on texture contrast.** Crispy spring rolls, fried tofu with any coating, tempura. Good reasons to eat in, not to order out.

**Salads.** The dressing problem is real. Salads arrive overdressed, underdressed, or already wilted.

---

## Tips for Ordering Vegan on Delivery Apps

**Call it out in the special instructions.** Even if you're ordering from a clearly labeled vegan item, add "please keep vegan" or "no dairy" in the notes.

**Check the restaurant's own ordering page.** Several Minneapolis restaurants offer direct delivery with lower fees than the third-party apps.

**Stick to dishes designed for that format.** Curries, stews, grain bowls, and rice-based dishes are built for containers.

**Order from fully vegan restaurants when you can.** Cross-contamination risk drops, and you don't need to interrogate every ingredient. The [plant-based restaurants guide for Minneapolis](/blog/plant-based-restaurants-minneapolis) includes several spots with delivery availability.
`,
  },

  {
    slug: "vegan-events-minneapolis",
    title: "Vegan Events in Minneapolis: What's Happening and Where to Look (2026)",
    description: "Where to find vegan events in Minneapolis — markets, festivals, community dinners, and the calendars worth following year-round.",
    publishedAt: "2026-04-16",
    updatedAt: "2026-04-16",
    author: "Mia & Jay",
    category: "Guide",
    tags: ["vegan events minneapolis", "vegan events minneapolis 2026", "plant-based events Twin Cities", "vegan festival minneapolis", "vegetarian events minneapolis", "Twin Cities VegFest"],
    readingTime: "5 min read",
    tldr: "Best sources for vegan events in Minneapolis: Minnesota Vegan Society (newsletter + Facebook group, best for community meetups and recurring events), Twin Cities VegFest (annual, largest plant-based event in the region, late summer/fall), Seward Co-op events calendar (cooking demos, tastings, year-round), Mill City Market (seasonal plant-based vendor days), and Eventbrite (cooking classes, pop-up dinners). Facebook groups and Instagram are where event discovery actually happens.",
    faqs: [
      {
        question: "Are there vegan events in Minneapolis in winter?",
        answer: "Yes. Indoor events — cooking demos, community dinners, Vegan Society meetups, and film screenings — run year-round. The outdoor markets and festivals are seasonal (roughly May through October), but the community doesn't hibernate."
      },
      {
        question: "Where is the best place to find vegan events in Minneapolis?",
        answer: "The Minnesota Vegan Society's newsletter and Facebook group cover the most ground. For restaurant-specific events, Seward Co-op's events calendar and individual restaurant newsletters are the most reliable. Eventbrite catches things that fall outside community channels."
      },
      {
        question: "Is Twin Cities VegFest free?",
        answer: "Twin Cities VegFest typically has a suggested donation or low entry fee rather than a mandatory paid ticket. Check their current year pricing — it varies slightly and sometimes early registration has different pricing than day-of."
      },
      {
        question: "What's the best vegan brunch spot for a group?",
        answer: "French Meadow handles groups best — larger space, clearly labeled menu, servers who know ingredients cold."
