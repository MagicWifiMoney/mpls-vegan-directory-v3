...
For more Minneapolis vegan dining, check our [vegan brunch guide](/blog/best-vegan-brunch-minneapolis) and [Minneapolis vegan food truck guide](/blog/minneapolis-vegan-food-trucks).
...

  {
    ...
    faqs: [
      ...
      {
        question: "Where can vegans get a romantic dinner with a view in Minneapolis?",
        answer: "Gandhi Mahal (3009 27th Ave S, Seward) has a riverside location on the Mississippi with views from the upper level. Reverie Cafe + Bar has a warm, intimate atmosphere that works well for evening dates. For rooftop or skyline views, check the current seasonal pop-ups and rooftop dining options in the downtown or North Loop area."
      }
    ],
    relatedRestaurants: ["j-selbys", "tongue-in-cheek", "gandhi-mahal", "reverie-cafe-bar", "tori-ramen", "shish-mediterranean", "french-meadow", "peninsula-malaysian"],
    relatedPosts: ["best-vegan-restaurants-minneapolis-2026", "vegan-brunch-minneapolis", "vegan-restaurants-uptown-minneapolis", "vegan-bars-breweries-minneapolis"],
    content: `
## Vegan Date Night in Minneapolis: The Full Guide

Minneapolis has one of the best plant-based dining scenes in the Midwest, and that extends to date-night caliber restaurants. Whether you're fully vegan, your partner is, or you're just trying to find somewhere that does both well, this guide covers the best options for a romantic evening out in 2026.

A few notes on how this list was built: "date night" means atmosphere matters as much as food. We're looking for places with candlelight or good lighting, some level of intention in the space, and food good enough to hold a conversation around without the meal itself becoming the topic. All of these work for a first date or a tenth anniversary.

---

## 🌿 The Top Pick: J. Selby's (St. Paul)

**Cathedral Hill, St. Paul | 169 Western Ave N | $$$ | Fully Vegan**

Let's start with the best. J. Selby's is a 100% plant-based restaurant in St. Paul's Cathedral Hill neighborhood — a 15-minute drive from South Minneapolis — and it is, without question, the finest vegan dining experience in the Twin Cities. White tablecloths, thoughtful lighting, a proper cocktail menu, and a kitchen producing food that impresses vegan and non-vegan guests equally.

This is the restaurant you go to when the date matters. Mother's Day, anniversaries, first dates where you want to make an impression, or any evening when mediocre food is not an option.

**What to order:**
- **Eggs Benedict** — poached tofu with house cashew hollandaise over an English muffin. It's the dish people talk about and it earns it.
- **House-made pasta** — rotates seasonally; whatever is on the menu is made in-house and plated beautifully
- **Charcuterie board** — plant-based charcuterie that converts skeptics
- **Bloody Mary or craft cocktails** — the bar program is serious

**Why it works for dates:** The atmosphere is genuinely romantic without being stuffy. Servers know the menu cold and can answer every question about sourcing and preparation. Non-vegan guests leave full and impressed. Vegan guests feel actually seen, not accommodated.

**Reservation strongly recommended**, especially on weekends.

---

## 🍜 Tori Ramen — Intimate and Cozy

**Northeast Minneapolis | 329 13th Ave NE | $$ | Vegan-Friendly**

Ramen is inherently a date food — the communal experience of a steaming bowl, the condensed conversation space of a small restaurant, the warmth. Tori Ramen in Northeast Minneapolis does it right, and critically for vegans, they offer a vegan tonkotsu-style broth that rivals the pork version in depth and richness.

The space is small, intimate, and always a little bustling — the right kind of energy for an early date where you want ambient noise to smooth over any awkward silences.

**What to order (vegan):**
- **Shio Ramen (vegan broth)** — request the vegan broth base, topped with mushrooms, corn, tofu, scallions
- **Vegan Tantanmen** — sesame-chili broth, ground plant-based protein, bok choy. The spicy option.
- **Gyoza** — crispy dumplings, vegan option available
- **Karaage (vegan version)** — fried cauliflower with house dipping sauce

**Why it works for dates:** Ramen removes the formality that makes some date dinners stiff. It's personal, it's warm, and the small space creates intimacy. Northeast Minneapolis's walkable bar scene means you can extend the evening easily after dinner.

---

## 🥗 Tongue in Cheek — Creative and Romantic

**Northeast Minneapolis | 1853 Ames Ave NE | $$$ | Plant-Forward**

Tongue in Cheek is the kind of restaurant that makes Northeast Minneapolis feel like a real dining destination. The menu is American creative with serious technique — it's not a vegan restaurant, but the kitchen treats its vegan dishes with the same care as everything else, and the vegan options are genuinely the best things on the menu.

The space is warm and candlelit with exposed brick and an open kitchen. It feels like the inside of a romantic movie about Minneapolis.

**What to order (vegan):**
- **Seasonal vegetable small plates** — the kitchen rotates creative vegetable preparations; order two or three to share
- **Grain bowl** — beautifully executed with local grains and seasonal produce
- **House-made pasta (vegan option)** — check current menu; the pasta program is serious
- **Craft cocktails** — the bar at Tongue in Cheek is one of the better ones in NE Minneapolis

**Why it works for dates:** The creative, sharing-plate format is perfect for dates — you eat together, you discuss the food, there's something to talk about. Non-vegan partners genuinely enjoy this restaurant without feeling like they're eating "vegan food." It's just excellent cooking that happens to accommodate.

---

## 🌊 Gandhi Mahal — River Views and Exceptional Vegan Indian

**Seward | 3009 27th Ave S | $$ | Vegan-Friendly**

Gandhi Mahal is an institution on the Minneapolis vegan scene, and it deserves its reputation. The restaurant sits on the Mississippi River in Seward with a beautiful upper-level dining room offering river views. The Indian menu has extensive clearly labeled vegan options across appetizers, mains, and desserts.

The atmosphere ranges from casual to romantic depending on where you sit — request the upstairs or window seating when you reserve.

**What to order (vegan):**
- **Samosas** — house-made, potato and pea filling, tamarind chutney
- **Chana Masala** — the standard-bearer version. Deeply flavored, properly spiced.
- **Dal Makhani (vegan version)** — ask for the vegan version without butter/cream; they do it beautifully
- **Garlic Naan (can be vegan)** — confirm with server; some preparations use butter
- **Mango Lassi (vegan version)** — made with coconut milk on request

**Why it works for dates:** A dinner with a river view and food you've been craving all week is hard to argue with. Gandhi Mahal strikes a warmth and coziness that makes it genuinely romantic. Sharing Indian food — passing dishes, trying each other's orders — is naturally intimate.

---

## 🍸 Reverie Cafe + Bar — The Fully Vegan Date Bar

**Powderhorn | 2506 Minnehaha Ave S | $$ | Fully Vegan**

Reverie is a fully vegan bar and restaurant in Powderhorn, and it is the best answer to "where do we go for drinks and something good to eat?" in Minneapolis. Twenty+ craft beers on tap, a cocktail menu that's actually creative, and food that includes the dark chocolate beignets that are genuinely one of the best desserts in the city.

The space is intimate and warmly lit — brick walls, candle-adjacent lighting, the kind of neighborhood bar you want your neighborhood to have.

**What to order:**
- **Dark Chocolate Beignets** — this alone justifies the visit. Rich, not-too-sweet, served with a dipping sauce.
- **Cashew Cheesecake** — rotating flavors; reliably excellent
- **Craft cocktails** — seasonally rotating, inventive, competently made
- **Draft beer selection** — 20+ taps rotating local and regional craft options

**Why it works for dates:** Reverie occupies the perfect middle ground between "restaurant" and "bar" — you can come for dinner, dessert and drinks, or just drinks. The fully vegan menu removes any uncertainty about asking "can they make this vegan?" And the warm, neighborhood feel is low-pressure in the way good date spots should be.

---

## 🫙 Shish Mediterranean — Mezze Made for Sharing

**Midtown | 2821 Hennepin Ave S | $$ | Vegan-Friendly**

Shish is the Mediterranean restaurant that gets the vegan-friendly memo right. The mezze-forward menu translates naturally to a vegan meal — hummus, falafel, roasted vegetables, stuffed grape leaves — and the sharing format is ideal for dates. The space is warmly lit and comfortable without being too loud.

**What to order (vegan):**
- **Hummus and pita** — made in-house, well-seasoned
- **Falafel plate** — crispy on the outside, herby and moist inside
- **Stuffed grape leaves (dolma)** — the vegan version is rice and herb stuffed
- **Fattoush salad** — bright, acidic, a perfect counterpoint to heavier dishes
- **Baba ganoush** — smoky and rich

**Why it works for dates:** Mezze is inherently social food — you share, you try each other's picks, you order more of what you loved. Shish has the right price point for a weeknight date without feeling like you're compromising on quality.

---

## Quick Reference: Vegan Date Night in Minneapolis

| Restaurant | Setting | Best For | Fully Vegan? |
|---|---|---|---|
| J. Selby's (St. Paul) | Upscale | Special occasions | Yes |
| Tongue in Cheek | Romantic, creative | Impressive first dates | No (strong vegan menu) |
| Gandhi Mahal | Riverside view | Cozy, international | No (extensive vegan) |
| Reverie Cafe + Bar | Intimate bar | Drinks + dessert dates | Yes |
| Tori Ramen | Cozy, casual | Relaxed evenings | No (vegan broth) |
| Shish Mediterranean | Warm, social | Sharing mezze dates | No (extensive vegan) |

For more Minneapolis vegan restaurant recommendations, explore the [MPLS Vegan directory](/restaurants) — browse by neighborhood, cuisine, or dietary need to find your next favorite spot.
`,
  },

  {
    slug: "vegan-grocery-stores-minneapolis",
    title: "Where to Buy Vegan Groceries in Minneapolis (2026 Guide)",
    description: "The complete guide to vegan grocery shopping in Minneapolis — from natural food co-ops to specialty vegan shops, bulk food stores, and mainstream supermarkets with the best plant-based selections. Includes neighborhood-by-neighborhood breakdown.",
    publishedAt: "2026-04-16",
    updatedAt: "2026-04-16",
    author: "Mia & Jay",
    category: "Guide",
    tags: ["vegan groceries minneapolis", "vegan grocery stores minneapolis", "where to buy vegan food minneapolis", "vegan grocery shopping minneapolis", "co-op minneapolis vegan", "whole foods minneapolis vegan"],
    readingTime: "7 min read",
    tldr: "Best vegan grocery shopping in Minneapolis: Seward Co-op (Seward, best overall bulk + produce selection), Wedge Community Co-op (Lowry Hill, most comprehensive natural food store), The Herbivorous Butcher (NE Mpls, 100% vegan meat and cheese alternatives), Mississippi Market (St. Paul, excellent and worth the drive), Whole Foods (Edina + Downtown), and Aldi for budget staples. Co-ops are the backbone of Minneapolis vegan grocery culture.",
    faqs: [
      {
        question: "What is the best vegan grocery store in Minneapolis?",
        answer: "Seward Co-op (2823 E Franklin Ave, Seward) and Wedge Community Co-op (2105 Lyndale Ave S, Lowry Hill) are the two best options for vegan grocery shopping in Minneapolis. Both have exceptional bulk food sections, curated natural food selections, clearly labeled vegan products, and strong produce departments sourced from local and regional farms when possible."
      },
      {
...
`,
...

  {
    ...
    faqs: [
      ...
      {
        question: "Are Minneapolis vegan events family-friendly?",
        answer: "Most of them are. The farmers market events, VegFest, and Seward Co-op cooking demos are all generally appropriate for kids. The evening social events (restaurant meetups, bar-based events) are adult-oriented."
      }
    ],
    relatedRestaurants: [],
    relatedPosts: ["best-vegan-restaurants-minneapolis-2026", "plant-based-restaurants-minneapolis", "best-vegan-bakeries-minneapolis", "vegan-brunch-minneapolis"],
    content: `
## Vegan Events in Minneapolis

Minneapolis has a real vegan community. Not just a cluster of restaurants — actual people organizing things, running markets, hosting dinners, and building something that shows up in more than just Yelp results.

If you know where to look, vegan events happen here year-round. The challenge isn't that they don't exist. It's that they're scattered across a dozen different channels, and the main ones worth following aren't always the most obvious ones.

Here's where to look and what to put on your calendar.

---

## Recurring Vegan Events Worth Knowing About

### Seward Co-op Events

Seward Co-op runs more events than most people realize. Cooking demos, nutrition workshops, community dinners, seasonal tastings — they put together a real programming calendar, and a significant portion of it is plant-based by default.

Check their events page directly and sign up for their email list. The cooking demos in particular tend to sell out or fill quickly, and they're not heavily promoted outside the co-op's own channels.

### Minneapolis Farmers Markets

Minneapolis farmers markets are themselves a kind of recurring vegan event — Saturdays at Mill City, Sundays at Northeast, the Midtown market through the week. But they also host dedicated plant-based and vegan vendor events throughout the season.

Mill City Market in particular has run specifically vegan-themed market days. Worth checking their event listings in May when the season gets going.

### Minnesota Vegan Society Events

The Minnesota Vegan Society is the main organized community hub for plant-based events in the Twin Cities. They run regular meetups, potlucks, and educational events throughout the year. Their Facebook group and newsletter are where events get announced.
...
Twin Cities VegFest is the largest dedicated plant-based event in the region. It typically runs in late summer or early fall and pulls in food vendors, speakers, exhibitors, and community organizations in one place.

It's the event most worth putting on your radar if you only track one thing. Good for newcomers to veganism and long-timers equally.

### Earth Day Events

Earth Day in Minneapolis (late April) reliably generates plant-based and sustainability events across the city. Restaurants do specials, community organizations run panels and screenings, and some venues run explicitly vegan pop-ups or dinners.

The Minnesota Vegan Society typically promotes the best of what's happening in the week around April 22.

### Holidays and Seasonal Pop-Ups

Thanksgiving and the holiday season generate more vegan food events than any other time of year in Minneapolis — community dinners, cooking demos, vegan holiday markets.

[Vegan bakeries in Minneapolis](/blog/best-vegan-bakeries-minneapolis) tend to launch seasonal menus around major holidays that don't exist the rest of the year.

---

## Where to Find Vegan Events in Minneapolis Year-Round

### Facebook Groups

The Minneapolis / St. Paul Vegan Facebook group is the best single source for community-organized events — pop-up dinners, meetups, one-off things that don't get promoted outside the group.

### Eventbrite

Eventbrite surfaces a lot of plant-based events in Minneapolis — cooking classes, wine and food pairings with vegan menus, wellness events. Search "vegan Minneapolis" or "plant-based Minneapolis" and filter by date range.

### Restaurant Newsletters

A handful of Minneapolis vegan restaurants and businesses run email lists that announce events before they hit social media. Seward Co-op and the co-op bakeries are worth subscribing to directly.

### Instagram

Instagram is where event discovery actually happens in Minneapolis food culture. Following local vegan restaurants, the Minnesota Vegan Society, and community accounts gets you into the real-time feed of what's happening.

---

**Looking for year-round vegan eating options?** Explore the [MPLS Vegan restaurant guide](/restaurants) for the full picture of where to eat plant-based in Minneapolis.
`,
  },
