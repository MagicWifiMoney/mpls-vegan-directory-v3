...
export const restaurants: Restaurant[] = [
  ...
  // Common Roots Cafe — CLOSED. Replaced by Hi Flora! then Dreamstate Cafe at 2558 Lyndale Ave S.
  {
    id: '29',
  ...
  },
  {
    ...
    slug: 'ipho-saigon',
    name: 'iPho by Saigon',
    address: '704 University Ave W',
    city: 'Saint Paul',
    state: 'MN',
    zip: '55104',
    phone: '(651) 222-5577',
    website: 'https://iphomn.com/',
  ...
  },
  {
    ...
    zip: '55405',
    phone: '',
    website: 'https://roottorisekitchen.com/',
    googlePlaceId: '',
    cuisineType: ['Plant-Based', 'THC Dining', 'Cafe'],
    veganStatus: '100% Vegan',
    neighborhood: 'Lyn-Lake',
    neighborhoodSlug: 'lyn-lake',
    description: "Hi Flora! opened on 4/20/2025 in the former Common Roots Cafe space at Lyndale and 26th, bringing something genuinely new to Minneapolis dining: a fully plant-based, alcohol-free restaurant built around Minnesota's legal THC beverages. Chef Heather Klein of Root to Rise Kitchen runs a menu that's creative, seasonal, and designed to pair with the bar's THC-infused drinks and mocktails. The concept is intentional — a social dining space where cannabis culture meets clean eating, without the booze. The Lyn-Lake location gives it walkable neighborhood energy, and the space itself carries a warm, inviting feel. If you're curious about the THC dining scene or just want excellent plant-based food in a distinctive setting, Hi Flora! is worth a visit.",
    priceRange: '$$',
    features: ['Dine-In', 'Takeout', 'THC Beverages', 'Alcohol-Free', 'Women-Owned'],
    coordinates: { lat: 44.9608, lng: -93.2880 }
  },
  {
    id: '57',
    slug: 'herbie-butchers-fried-chicken',
    name: "Herbie Butcher's Fried Chicken",
    address: '507 1st Ave NE',
    city: 'Minneapolis',
    state: 'MN',
    zip: '55413',
    ...
    website: 'https://www.theherbivorousbutcher.com/',
    googlePlaceId: '',
    cuisineType: ['Fried Chicken', 'Fast Casual', 'Comfort Food'],
    veganStatus: '100% Vegan',
    neighborhood: 'Northeast Minneapolis',
    neighborhoodSlug: 'northeast',
    ...
    priceRange: '$',
    features: ['Takeout', 'Fast Casual', 'Comfort Food'],
    coordinates: { lat: 44.9936, lng: -93.2636 }
  },
  {
    id: '58',
  ...
  },
  {
    ...
    website: '',
    googlePlaceId: '',
    cuisineType: ['Juice Bar', 'Smoothies', 'Raw'],
    veganStatus: '100% Vegan',
    neighborhood: 'Minneapolis',
    neighborhoodSlug: 'downtown',
    description: "Life Juices is an all-vegan juice bar in Minneapolis offering cold-pressed juices, smoothies, and plant-based bites. Listed on multiple local vegan guides, it's a solid pick for a quick, clean meal or a post-workout refuel. The focus is on fresh, whole ingredients — no dairy, no meat, no compromises.",
    priceRange: '$',
    features: ['Takeout', 'Juice Bar', 'Healthy'],
    coordinates: { lat: 44.9778, lng: -93.2650 }
  },
  {
    id: '60',
    slug: 'hark-cafe',
    name: 'Hark! Cafe',
    address: '430 First Ave N Ste 150',
    city: 'Minneapolis',
    state: 'MN',
    zip: '55401',
    phone: '',
