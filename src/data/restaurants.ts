...
export const restaurants: Restaurant[] = [
  ...
  },
  {
    ...
    googlePlaceId: 'ChIJRXWS74Yp9ocRsxTgSfYt_zk',
  ...
  },
  {
    ...
    googlePlaceId: 'ChIJe18Tmogn9ocR7UpRi67Wfz8',
    cuisineType: ['Pizza', 'Delivery'],
    veganStatus: 'Vegan-Friendly',
    neighborhood: 'Lyn-Lake',
    neighborhoodSlug: 'lyn-lake',
    description: "An eco-conscious pizzeria famous for delivery by electric car and superhero-costumed drivers. Galactic Pizza takes their vegan options seriously—Daiya cheese melts beautifully on creative pies like the Earth Pizza loaded with vegetables. The organic wheat crust is excellent, and gluten-free options are available. Beyond the gimmicks, the pizza is genuinely good and the commitment to sustainability is real: wind-powered, compostable packaging, organic ingredients. A fun option for family pizza night.",
    priceRange: '$$',
    features: ['Dine-In', 'Takeout', 'Delivery', 'Sustainable', 'Gluten-Free Options'],
    coordinates: { lat: 44.9471, lng: -93.2879 }
  },
  {
    id: '39',
  ...
  },
  {
    ...
    phone: '(612) 345-7064',
    website: 'https://glamdolldonuts.com/',
    googlePlaceId: 'ChIJd83564d4cf31da27Minneapolis',
    cuisineType: ['Bakery', 'Donuts', 'Desserts'],
    veganStatus: 'Vegan-Friendly',
    neighborhood: 'Lyn-Lake',
    neighborhoodSlug: 'lyn-lake',
    description: "The most famous donut shop in Minneapolis, Glam Doll is known for its over-the-top creations and extensive vegan selection. Unlike most donut shops where vegans get one sad option, Glam Doll offers a full lineup of vegan donuts made with coconut milk, cornstarch, coconut oil, and fried in soy-cottonseed oil. Expect wild flavor combinations like the Chart Topper (peanut butter and sriracha!) alongside classics done exceptionally well. The Misfit Donut is a fan favorite. Every vegan donut is clearly marked, and the selection changes regularly to keep things interesting. The Instagram-worthy aesthetic extends to the shop itself—funky, colorful, unapologetically extra. Weekend mornings see lines out the door, but they move fast. Perfect for when you want a donut that tastes amazing AND looks like art. Multiple locations around the Twin Cities.",
    priceRange: '$$',
    features: ['Takeout', 'Multiple Locations', 'Vegan Options', 'Instagram-Worthy'],
    coordinates: { lat: 44.9551, lng: -93.2777 },
    whatToOrder: [
      'Misfit Donut - The fan-favorite signature creation',
    ...
    bestFor: ['Weekend treats', 'Instagram photos', 'Donut obsessives', 'Adventurous eaters', 'Gifts'],
    theVibe: "Funky, colorful, over-the-top donut shop where vegan options are taken seriously. Expect a wait on weekends, but it moves fast.",
    relatedBlogs: ['vegan-bakeries-minneapolis', 'vegan-comfort-food-minneapolis', 'best-vegan-restaurants-minneapolis-2026']
  },
  {
    id: '50',
    slug: 'lutunjis-palate',
    ...
    zip: '55404',
    phone: '(612) 123-4567',
    website: 'https://www.lutunjispalate.com/',
    googlePlaceId: 'ChIJLutunjiPalate2026Mpls',
    cuisineType: ['Bakery', 'Desserts', 'Plant-Based'],
    veganStatus: '100% Vegan',
    neighborhood: 'Elliot Park',
    neighborhoodSlug: 'elliot-park',
    description: "It all started with peach cobbler. Baker and owner Lutunji Abram created a vegan version with a coconut oil crust so good that Pastor Jeff Cowmeadow convinced her to share it with the world. What began in the kitchen of Calvary Church has grown into a beloved Minneapolis bakery specializing in plant-based and gluten-free desserts with a nutritive twist. Lutunji incorporates ingredients like turmeric, mineral-rich algae, organic beets, and oranges—not just for color, but for actual health benefits. The vegan peach cobbler remains the star of the show, but everything from the cakes to the cookies delivers both flavor and function. This is dessert that doesn't apologize for being good for you, because it tastes too damn good to need an excuse. Perfect for health-conscious vegans who still want indulgence, or anyone looking for desserts that spark conversation.",
    priceRange: '$$',
    features: ['Takeout', 'Custom Orders', 'Gluten-Free Options', 'Nutritive Ingredients'],
    coordinates: { lat: 44.9658, lng: -93.2652 },
    whatToOrder: [
      'Vegan Peach Cobbler - The legendary coconut oil crust original',
      'Turmeric Cake - Anti-inflammatory AND delicious',
      'Beet-Orange Treats - Natural color, unexpected flavor',
      'Custom Celebration Cakes - Healthy enough to feel good about'
    ],
    bestFor: ['Health-conscious vegans', 'Unique gifts', 'Allergy-friendly desserts', 'Special occasions'],
    theVibe: "Community-focused bakery where desserts have a purpose beyond taste. Warm, welcoming, and committed to both flavor and nutrition.",
    relatedBlogs: ['vegan-bakeries-minneapolis', 'best-vegan-restaurants-minneapolis-2026']
  },
  {
    id: '51',
