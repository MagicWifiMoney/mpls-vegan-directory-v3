...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Vegan Restaurants by Neighborhood — Minneapolis & Saint Paul',
    description: 'Explore vegan dining options in every Minneapolis and Saint Paul neighborhood',
...
export default function NeighborhoodsPage() {
  ...
  const allNeighborhoods = [...minneapolisNeighborhoods, ...saintPaulNeighborhoods];
  const itemListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: 'Minneapolis & Saint Paul Vegan Neighborhoods',
    description: 'Explore vegan and plant-based restaurants by neighborhood in the Twin Cities',
    numberOfItems: allNeighborhoods.length,
    itemListElement: allNeighborhoods.map((n, i) => ({
      '@type': 'ListItem',
      position: i + 1,
      name: `${n.name} — Vegan Restaurants`,
